...
export const config = {
  ...
  location: { de: "Wien, Österreich", en: "Vienna, Austria" },
  available: true,
  ...
  skills: [
    ...
    "Prompt Engineering", "LLM Integration", "Core ML",
  ],
  ...
  de: {
    ...
    projects: [
      ...
      },
      {
        ...
        description: "Persönliches Projekt: Eine online Wort-Puzzle Spiel, entwickelt mit TypeScript.",
      ...
      {
        name: "Kombinationen App",
        description: "Persönliches Projekt: Eine Wort-Puzzle Spiel als native iOS-App.",
        image: "/kombinationen-ios.png",
        tags: ["iOS", "Swift"],
        link: null,
        liveUrl: "https://apps.apple.com/us/app/kombinationen/id6778870369",
      },
      {
  ...
  en: {
    ...
    projects: [
      ...
      {
        name: "kombinationen.com",
        description: "Personal project: An online word puzzle game built with TypeScript.",
        image: "/kombinationen.png",
        tags: ["TypeScript"],
        link: null,
        liveUrl: "https://kombinationen.com",
      ...
      {
        name: "Kombinationen App",
        description: "Personal project: A word puzzle game as a native iOS app.",
        image: "/kombinationen-ios.png",
        tags: ["iOS", "Swift"],
        link: null,
        liveUrl: "https://apps.apple.com/us/app/kombinationen/id6778870369",
      ...
      {
        name: "Hero Stream Games",
        description: "Personal project: A gaming web app for a streamer duo with games played interactively with the chat during live streams. Built with TypeScript and hosted on Vercel.",
        image: "/hero-stream-games.png",
        tags: ["TypeScript", "Vercel"],
        link: null,
        liveUrl: "https://hero-stream-games.vercel.app",
