...
export const config = {
  ...
  en: {
    ...
    education: [
      ...
      {
        degree: "Dual Study – Online Media",
        institution: "DHBW / Dichtungs Specht, Mosbach",
        period: "Feb 2017 – Jun 2018",
        description: "",
      },
    ...
    experience: [
      ...
      },
      {
        ...
        period: "Jul 2019 – Aug 2022",
        description: "Entry into professional iOS development. Contributed to multiple client projects, including the GeorgeID app for Erste Bank Austria (MacOS SwiftUI).",
        tags: ["Swift", "UIKit", "SwiftUI", "Xcode"],
      },
    ],
